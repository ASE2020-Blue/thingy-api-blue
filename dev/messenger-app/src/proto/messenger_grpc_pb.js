...
function serialize_messenger_TestMessageRequest(arg) {
  if (!(arg instanceof messenger_pb.TestMessageRequest)) {
    throw new Error('Expected argument of type messenger.TestMessageRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_messenger_TestMessageRequest(buffer_arg) {
...
var MessengerService = exports.MessengerService = {
  sendTestMessage: {
    ...
    requestSerialize: serialize_messenger_TestMessageRequest,
    requestDeserialize: deserialize_messenger_TestMessageRequest,
