...
interface IPersistLocalizationService_IGetPendingLocation extends grpc.MethodDefinition<google_protobuf_empty_pb.Empty, thingy_localization_pb.ThingyLocalization> {
    path: "/PersistLocalization/GetPendingLocation";
    requestStream: false;
    responseStream: true;
    requestSerialize: grpc.serialize<google_protobuf_empty_pb.Empty>;
    requestDeserialize: grpc.deserialize<google_protobuf_empty_pb.Empty>;
    responseSerialize: grpc.serialize<thingy_localization_pb.ThingyLocalization>;
    responseDeserialize: grpc.deserialize<thingy_localization_pb.ThingyLocalization>;
}
...
export interface IPersistLocalizationServer {
    ...
    getPendingLocation: grpc.handleServerStreamingCall<google_protobuf_empty_pb.Empty, thingy_localization_pb.ThingyLocalization>;
}
...
export interface IPersistLocalizationClient {
    ...
    getPendingLocation(request: google_protobuf_empty_pb.Empty, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<thingy_localization_pb.ThingyLocalization>;
    getPendingLocation(request: google_protobuf_empty_pb.Empty, metadata?: grpc.Metadata, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<thingy_localization_pb.ThingyLocalization>;
}
...
export class PersistLocalizationClient extends grpc.Client implements IPersistLocalizationClient {
    ...
    public getPendingLocation(request: google_protobuf_empty_pb.Empty, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<thingy_localization_pb.ThingyLocalization>;
    public getPendingLocation(request: google_protobuf_empty_pb.Empty, metadata?: grpc.Metadata, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<thingy_localization_pb.ThingyLocalization>;
}
